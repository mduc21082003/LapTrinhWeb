...
<body>
    <div class="container mt-5">
        <h1 class="text-center" style="color: darkblue;">Department Management</h1>
                ...
                <?php foreach ($departments as $department): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger" href='delete_department.php?id=<?php echo $department['department_id']; ?>' onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <div class="text-center">
            <a class="btn btn-success mb-5" href="add_department.php">Add Department</a>
        </div>
        <div class="text-center">
