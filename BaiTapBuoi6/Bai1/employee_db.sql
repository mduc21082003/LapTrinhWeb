...
CREATE TABLE `departments` (
  ...
  `department_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
...
ALTER TABLE `employees`
  ...
  ADD KEY `_department_id` (`department_id`);
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `_department_id` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
